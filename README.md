...
_Diagram is schematic — y-axis not to scale across methods. Option 2 shape reflects the tool's log-area correction (n ∝ [1 + log₁₀(area/1000)]²); Option 1 reflects linear summation of ~31 plots per sub-unit._
